...
Both sides are completely flat; the *Volt logo* is visible purely through *multi-colour
printing* – the logo area and the background are printed in contrasting colours. A narrow
rim runs around the edge.
...
| Shape | Round disc with raised rim, both faces flat
