= EU-Schnalle – Pendant for a Bracelet or Necklace
:toc:
:toc-title: Contents
:icons: font

image::resources/IMG_1157.JPEG[EU-Schnalle pendants in various sizes and color variants with bands, 480]

== What is it?

The *EU-Schnalle* ("EU buckle") is a round, flat pendant (37 mm diameter) in
...
image::resources/EU-Schnalle-plate-preview.png[Print plate with several pendants, 360]
...
The pendant is built up from bottom to top: several *base layers*, then a
